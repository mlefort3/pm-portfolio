...
const myHTMLFirstPart = `<div style="fontWeight:'bold',mt:2,ml:3,textAlign:'left'"><h1>La masculinité toxique</h1>
...
export default function MasculiniteToxique () { return(
  <div>
